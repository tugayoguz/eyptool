...
public class EvrakServiceImpl extends BaseServiceImpl implements EvrakService{
	...
	public EvrakDTO getEvrakDTOWithRefNo(Long refNo){
		...
		evrakDTO.setEvrakPostaDTOList(getEvrakPostaService().getEvrakPostaDTOWithRefNo(refNo));
		return evrakDTO;
	}
	...
	public EvrakPostaService getEvrakPostaService() {
		return evrakPostaService;
	}

	public void setEvrakPostaService(EvrakPostaService evrakPostaService) {
		this.evrakPostaService = evrakPostaService;
	}
